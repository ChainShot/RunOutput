...
export default () =>
    <svg aria-hidden="true" data-prefix="fal" data-icon="minus-square" role="img" xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 448 512" className="svg-inline--fa fa-minus-square fa-w-14 fa-9x">
